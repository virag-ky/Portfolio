const cssArtProjects = [
  {
    ...
    description:
      "I created this CSS art project of my chihuahua to contribute to 'Zero to Mastery' CSS Art project. The requirements: make at least one animation in your art and use only HTML and CSS, no JavaScript! I added animation to the ears.",
    languagesTools: ["HTML", "CSS"],
    liveUrl: "https://virag-ky.github.io/CSS-Art-Chihuahua/",
    githubUrl: "https://github.com/virag-ky/CSS-Art-Chihuahua",
    id: 27,
  },
  {
