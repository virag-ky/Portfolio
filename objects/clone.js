const cloneProjects = [
  {
    ...
    image: '../images/projects/google-homepage.png',
    description:
      'A static clone of the Google homepage, made with HTML and CSS. This was my very first project I built.',
  ...
  },
  {
    ...
    description:
      'A static Youtube clone project where I display some of my favorite music videos. The videos are embedded in HTML and the user can view them.',
  ...
  },
  {
    ...
    description:
      "This is my first capstone project from Microverse, the topic is about a web development course. The user can navigate between the 'homepage' and the 'about' page. The featured teachers section is made with JavaScript.",
